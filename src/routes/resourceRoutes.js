...
router.get('/course/:courseId', verifyToken, isSecretaireOrAdmin, validateUUIDParam('courseId'), getResourcesByCourse);
...
router.delete('/:id', verifyToken, isSecretaireOrAdmin, deleteResource);
